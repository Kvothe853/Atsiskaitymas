...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 22, 2021 at 10:49 AM
...
(2, 'Tomas Žigutis', '2021-06-22 08:31:20', 'JavaScript programuotojas', 'JavaScript programuotojo modulinė profesinio mokymo programa skirta parengti kvalifikuotą darbuotoją, gebantį projektuoti ir kurti vartotojo kompiuteriuose, išmaniuosiuose telefonuose.', 'JavaScript programuotojo modulinė profesinio mokymo programa skirta parengti kvalifikuotą darbuotoją, gebantį projektuoti ir kurti vartotojo kompiuteriuose, išmaniuosiuose telefonuose, planšetėse ir kt. prieigos įrenginiuose naudojamą programinę įrangą (angl. front-end), parengtą jungtis prie serverių sistemų, duomenų bazių, valdyti programavimo aplinką ir kūrimo procesą.', 'images/tomas.png', 36, 'Labai naudingas kursas, daug išmokau. Aišku, mokytis reikėjo uoliai ir atsakingai :)', 3032, 4),
(3, 'Simona Valiukaite', '2021-06-22 08:36:49', 'PHP programuotojas', 'PHP programuotojo modulinė profesinio mokymo programa skirta parengti kvalifikuotą darbuotoją, gebantį projektuoti ir kurti pilnai funkcionuojančias informacines sistemas.', 'PHP programuotojo modulinė profesinio mokymo programa skirta parengti kvalifikuotą darbuotoją, gebantį projektuoti ir kurti pilnai funkcionuojančias informacines sistemas (angl. full stack), tam panaudojant nesudėtingas duomenų bazes, valdyti programavimo aplinką ir kūrimo procesą. valdyti PHP programavimo aplinką ir kūrimo procesą.', 'images/simona.png', 28, 'Labai daug informacijos, tačiau įmanoma. ', 2554, 5),
...
(5, 'Lukas Visockas', '2021-06-22 08:38:48', 'Multimedijos Technikas', 'Multimedijos techniko modulinė profesinio mokymo programa skirta kvalifikuotam multimedijos technikui parengti, kuris gebėtų savarankiškai kurti bei redaguoti dvimatės ir trimatės grafikos produktus', 'Multimedijos techniko modulinė profesinio mokymo programa skirta kvalifikuotam multimedijos technikui parengti, kuris gebėtų savarankiškai kurti bei redaguoti dvimatės ir trimatės grafikos produktus, kurti ir redaguoti animacijos produktus, kurti, montuoti bei redaguoti vaizdo ir garso produktus, kurti skaitmeninės komunikacijos kanalus ir publikuoti vaizdo bei garso produktus.', '', 12, 'Išties įspūdingas kursas, likau labai patenkintas,ne tik, kad pagilinau turimas žinias, bet ir sutikau daug bendraminčių su kuriais dabar dirbame prie naujo projekto! ', 1054, 3);
